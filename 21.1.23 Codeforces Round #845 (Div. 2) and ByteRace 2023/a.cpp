...
void test(){
  ...
  //product of 2 odd is a odd and product of 2 even is a even
  //hence count the number of continuous odds and evens and the number -1 is the no. of operations needed
  int op = 0, c = 0;
  fori(0,n-1){
    if(a[i]%2 == a[i+1]%2) c = (c==0)?2 : c+1;
    else if(c!= 0){
      op+=c-1;
      //reset
      c = 0;
