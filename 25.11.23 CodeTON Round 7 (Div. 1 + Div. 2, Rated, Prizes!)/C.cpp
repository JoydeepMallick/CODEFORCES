...
void test(){
  ...
  //from careful observation we find that when a possible sequence of b for a given x only exists when exactly x elements of a are greater than b when compared in sorted fashion.
  //
  //
  //i.e.       last example can be sorted to :-
  //           
