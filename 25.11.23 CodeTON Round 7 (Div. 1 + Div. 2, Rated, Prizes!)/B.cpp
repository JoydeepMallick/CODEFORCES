...
void test(){
  ...
  //see this format  BBBB... A (anything) B ....AAA
  //                        _______________
  //                        this length - 1 will always be the answer
  //

  ll ans = 0, indstart = -1, indend = -1;
  bool foundfirsta = false, foundlastb = false;
  fori(0,n){
      if(s[i] == 'A' && !foundfirsta){
          foundfirsta = true;
          indstart = i;
          break;
      }
  ...
  if(foundfirsta && foundlastb) ans = indend - indstart;
