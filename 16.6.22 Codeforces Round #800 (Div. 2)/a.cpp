...
void test(){
	//write code here
  //minimum possible creepiness here should be 0 
  //we basically need to form a prefix string of k 0s k 1s and then remaining can go to any possition oesnt matter
  int a,b;
  cin >> a >> b;
  if(a>=b)//more 0
  {
