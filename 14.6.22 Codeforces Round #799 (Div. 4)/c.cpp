...
void test(){
	//write code here
  cout << endl;//newline before each test case
  char board[8][8];
  fori(0,8)
  {
    forj(0,8)
  ...
  int r = 0,c = 0;//wrong case
  fori(0,7)//0 1 2 3 4 5 6
  {
    forj(0,6)//0 1 2 3 4 5
    {
      if(board[i][j]=='#' && board[i][j+2]=='#')//checks from top to down
      {
        c = j+1;//always same
