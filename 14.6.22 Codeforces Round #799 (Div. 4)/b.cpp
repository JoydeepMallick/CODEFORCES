...
void test(){
  ...
  c = n - unique.size();
  //total no of elements - total no  of unique elements
  if(c%2)
  {
    cout << unique.size()-1 << endl;//1 1 2-->3 - 2 is odd hence on removingone non unique element another element needs to be removed in this case
  }
  else
  {
