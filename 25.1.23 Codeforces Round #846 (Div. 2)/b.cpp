...
void test(){
    ...
    /*
     for max score , we need value of gcd to be maximum, this can only happen when most of the bi values has near about same factors except for atmost one uncommon factor in suitable k terms where k must greater than 1 as given
...
ans = 4
 ...
 ____  ________  _
ans = 3 
most optimal since other combination reduces overall gcd

we always try grouping 1 by 1 for each until we hit a sum different
