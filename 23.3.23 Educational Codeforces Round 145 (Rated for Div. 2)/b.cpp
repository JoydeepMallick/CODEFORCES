...
void test(){
    ull n;
    cin >> n;
    //start at 0,0 and spread equally in all directions to minimize the costs for each 
    //spreading happens in multiple of 4 to cover a surrounding  i.e.   1,4     5, 9,   13,17,   .........
    //                                                              
    dbg(n);
    ull ans = n/2;
    cout << ans << endl; 
