...
void test(){
  ...
  ll ans;
//if some character is present more than floor(n/2) times then it will defintely be present in final string, ans will be 1, 2,.... depending on n - 2*(cnt of remaing lower freq charaters in total = n - freq of max occuring character). 
//else answer will always be 0.
