...
/* cin >> a[i][j]; */
            ...
            cin >> shot;
            if(shot == 'X'){
                if(i == 1 || i == 10 || j == 1 || j == 10) totalpoints+=1;
                else if(i == 2 || i == 9 || j == 2 || j == 9) totalpoints+=2;
                else if(i == 3 || i == 8 || j == 3 || j == 8) totalpoints+=3;
                else if(i == 4 || i == 7 || j == 4 || j == 7) totalpoints+=4;
                else if(i == 5 || i == 6 || j == 5 || j == 5) totalpoints+=5;
            }
        }
    }
