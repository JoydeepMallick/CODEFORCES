...
void func(int maxside, int rec2[], int rec3[]){
  if((rec2[1] == rec3[1] && rec2[0] + rec3[0] == maxside) || (rec2[0] == rec3[0] && rec2[1] + rec3[1] == maxside)){
    yes;
  }else no;
}
...
void test(){
    ...
    //find max value 
    int maxside = max({l1, l2, l3, b1, b2, b3});

    int rec1[2] = {0}, rec2[2] = {0}, rec3[2] = {0};
    //seperate max value rectangle
    if(maxside == l1 || maxside == b1){
      rec1[0] = l1; rec1[1] = b1;
      rec2[0] = l2; rec2[1] = b2;
      rec3[0] = l3; rec3[1] = b3;
    }else if(maxside == l2 || maxside == b2){
      rec1[0] = l2; rec1[1] = b2;
      rec2[0] = l1; rec2[1] = b1;
      rec3[0] = l3; rec3[1] = b3;
      }
    else if(maxside == l3 || maxside == b3){
      rec1[0] = l3; rec1[1] = b3;
      rec2[0] = l1; rec2[1] = b1;
      rec3[0] = l2; rec3[1] = b2;
    }    
  func(maxside, rec2, rec3);
}
