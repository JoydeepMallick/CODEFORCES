...
void test(){
  ...
  fori(0,n) forj(0,m) cin >> mat[i][j];

/* printmat(mat); */

/* For a matrix of type 1 */

/* , Misha can block all empty cells (except the one Vova stands on). */

/* For a matrix of type 2 */

/* , Misha finds the shortest path to some exit with a single BFS and then blocks every other cell. */

/* Matrices of type 3 */
/* are more complicated. We want to find two shortest paths to the two closest exits and block the remaining empty cells. */


/* 😥solution is fucking pain */
}
