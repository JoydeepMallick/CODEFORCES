...
// can be achieved via suffix sum of array and then while traversing over suffix array that add up to a positive value.
//
// 3 2 -4 -7 3 10 -5 8 -3 1 
//    <---------------
// 8 5 3 7 14 11 1 6 -2 1  = suffix sum 
//
// ans = 8 + 5 + 3 + 7 + 14 + 11 + 1 + 6 + 1 = 56
//
// means we take in following order :-
//                        1 
//                   8 -3 1
//                -5 8 -3 1 
//             10 -5 8 -3 1
...
// 3 2 -4 -7 3 10 -5 8 -3 1
//
// hence the partitions are  :-  [3] [2] [-4] [-7] [3] [10] [-5] [8,-3] [1] 
//    maxsum                    = 3 + 4  -12  -28 + 15 + 60  -35 + 40  + 9 = 56 
  ...
  ll ans = suffix[0];//all the elements sum will the minimum we are sure to take in every calculation
  fori(1,n){
