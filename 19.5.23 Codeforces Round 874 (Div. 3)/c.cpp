...
void test(){
    ...
    sort(a,a+n);
    /*
     * note :- after array has been sorted 
     *
     * not possible cases   --   e o  e ........
     *                           e e e e e...... o o o o o ... e or o ..
     *                           e o 
     *                           if it starts with even no odd must exist for n > 2  
     *
     * always possible cases --  o e  o .......
     *                           o o o o o.....e e e e e ... e  or o ..
     *                           o e 
     *                           o o 
     *                           e e 
     *                           o 
     *                           e 
     *                           if starts with odd ok always 
     */
    if(n==1 || (n==2 && (a[0]%2==1 || (a[0]%2==0 && a[1]%2==0)))) yes;
    else if(n==2) no;

    else if(n>=3){
        fori(0,n){//parity converter
            a[i] = a[i]%2;
        }

        if(a[0]==1 && a[1]==0 && a[2]==1) yes;
        else if(a[0]==0 && a[1]==1 && a[2]==0) no;
        else{
            if(a[0]==1) yes;
            else{
                ll oddexist = 0;
                //check if all even else no;
                fori(0,n){
                   oddexist += a[i]; 
                }
                if(oddexist) no;
