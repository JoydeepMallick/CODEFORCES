...
void test(){
    ...
    cin >> a >> b >> c >> d;
    int diagmoves = d-b;
    if(b > d || a+diagmoves < c) cout << -1 << endl;//can go down or right after reached req y
    else{
        // -1 0 -1 2   
        //--> 0  1  ->  1  2  ->  0 2  ->  -1 2      4 arrows 4 steps 
/* dbg(diagmoves, a+diagmoves); */
        cout << diagmoves + (a + diagmoves) - c << endl;
    }
}
