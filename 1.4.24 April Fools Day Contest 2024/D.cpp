...
void test() {
  string n;
  cin >> n;
  /* cout << "Procrastinator" << endl; */ // procrastintor keeps
                                          // delaying things that
                                          // must be done
  /* no; */                               // skill issue
  /*yes;//I have no reason to believe you. */
  /* cout << "maybe" << endl;//I am yet to download enough RAM. Give me short
   * and concise responses that I can understand. */
  /* cout << "yesno" << endl;//"yes" and "no"? So you are both a procrastinator
   * and not? I do not believe you. */
  cout << "ok" << endl;
}
