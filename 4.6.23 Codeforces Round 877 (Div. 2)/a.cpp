...
If there are only nonnegative integers, note that the maximum number remains the same after performing an operation, because for nonnegative integers a
, b, where a≤b, we have
|a−b|=b−a≤b

Therefore, in this case, the maximum number in the list must be one of the original numbers.
