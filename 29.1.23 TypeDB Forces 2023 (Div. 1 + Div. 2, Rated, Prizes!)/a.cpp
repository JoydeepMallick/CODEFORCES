...
void test(){
    int n;
    cin >> n;
    //min element of n is 2(1,1),then 4(1,2), 6(1,3),.... if one element is 1 then other element always half of n
    //if(2,2) 2*2^3 = 16 ,   (3,3) 2* 3^4 = ..., 
    //
    //ie. if both elements are same then 2*(x^(x+1)) = n
    //
    //one important thing to notice no odd n can be possible hence....
