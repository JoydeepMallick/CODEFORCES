...
void test(){
    ...
    /*
     e.g. 1 2 3 4 5
          ...
          So minimum number is n-1 times, 2nd minimum is n-2 times and so on, last number is unachievable so it must be some greater or the same as 2nd maximum as obtained from array 

          so first sort array b 

          then jump by n-i times to get ith smallest number in array
     */
    ...
    a.pb(a.back());// duplicate last element for last position since it can only be it or something more 
    print(a);
